  ...
  const NoChatsMessage = () => (
    <div className="flex items-center justify-center h-full bg-gray-50">
      <div className="text-center p-6">
        ...
        <p className="text-sm text-gray-500 max-w-xs">{chat('no_conversations_yet')}</p>
      </div>
    </div>
  );

  return (
    <div className="w-full mt-2 md:mt-4 md:rounded-md flex items-center justify-center overflow-hidden bg-white shadow-sm border border-gray-100">
