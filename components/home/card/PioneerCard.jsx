...
function PioneerCard({ icon, title, desc }) {
  return (
    <div className="lg:w-[259px] md:w-[230px] relative w-full shrink-0 px-2 border-gray-300 h-32 md:h-[220px] gap-y-2  flex items-center flex-col justify-center bg-white shadow-[0px_4px_4px_rgba(0,0,0,0.2)]  border-[1px]">
