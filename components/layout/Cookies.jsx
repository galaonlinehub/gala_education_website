  ...
  return (
    ...
    >
      <div className="text-black w-full lg:w-1/2 leading-relaxed px-1 lg:px-0">
        We use cookies and similar technologies on our website to enhance site navigation, analyze
        site usage, and assist in our marketing efforts. Accept all cookies or customize your
        settings to individually select which cookies you allow. For more information see our{' '}
        <span
