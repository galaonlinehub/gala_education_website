...
const ScrollableContent = () => {
  ...
  return (
    <div className="relative w-5/6 h-[35rem]">
      {showLeftArrow && (
        <button
          onClick={() => scroll('left')}
          className="absolute left-2 top-1/2 z-10 transform -translate-y-1/2 bg-white/80 p-2 rounded-full shadow-lg hover:bg-white transition-colors"
        >
      ...
      {showRightArrow && (
        <button
          ...
          className="absolute right-2 top-1/2 z-10 transform -translate-y-1/2 bg-white/80 p-2 rounded-full shadow-lg hover:bg-white transition-colors"
        >
      ...
      >
        <div className="flex flex-col gap-12 sm:flex-row px-20 h-fit sm:h-[30rem] w-full flex-shrink-0" style={{ scrollSnapAlign: 'start' }}>
          <div className="relative w-full sm:w-1/2 items-center  mt-14 h-44 md:h-4/5 max-sm:p-2">
