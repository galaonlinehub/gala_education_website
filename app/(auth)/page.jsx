...
function Home() {
  ...
  return (
    <div className="relative w-screen mx-auto h-full">
      {showDonatePopup && (
        <div className="fixed inset-0 bg-black bg-opacity-70 !z-[999] flex justify-center items-center">
        ...
        <div className="md:w-1/2 w-full mb-20">
          <div className="flex flex-col gap-4 w-full h-3/4">
            ...
            <div className="text-xs leading-loose text-justify md:text-left ">
              In Tanzania, many families face the heart-wrenching struggle of
              providing quality education for their children due to a severe
              lack of qualified teachers and resources. Gala Education was born
              from a deep desire to change this reality, offering hope through
              high-quality online tutoring for Primary, Secondary, and High
              School students. We not only provide jobs for teachers but also
              reinvest our profits into building classrooms, libraries, hiring
              part-time instructors and more, bringing dreams within reach for
              countless children across Tanzania. Additionally, our platform
              offers a variety of short courses designed to equip young
              Tanzanians with practical, self-employable skills taught by
              experts in various fields. Join us in making a profound
      ...
      <div className="relative flex items-center w-full mt-6 md:h-[60rem] lg:h-[50rem] ">
        <div className=" w-full mt-2 py-4 px-6 flex gap-5 items-center flex-col h-fit">
          ...
          <h2 className="text-center text-xs">
            We aim to integrate AI to provide personalized, AI-powered tutoring
        ...
        <div className="relative max-sm:w-screen h-[32rem] w-full max-w-screen-2xl mx-auto mt-4 md:mt-8 lg:mt-4 px-6 sm:px-4 py-6 sm:py-10 flex flex-col md:flex-row">
          <div className="hidden md:block w-full">
            <div className=" w-full flex flex-col items-center gap-3 p-4">
              ...
              <h3 className="text-center text-xs md:w-2/3 w-full mb-4 sm:text-sm leading-relaxed sm:px-6 ">
                Join Gala Education today - register as a teacher or student and
      ...
      <div className="relative flex items-center w-full px-6 ">
        <div className=" w-full mt-1 py-4 flex gap-5 items-center justify-center flex-col h-fit">
          ...
          <h2 className="text-center w-full px-3 md:w-2/3 text-xs">
            ...
            platform has had on their learning journey. Here’s what they have to
            say about Gala Education.
          </h2>
          <div className="hidden md:block">
      ...
      <div className="relative w-full h-[30rem] md:h-[25rem] overflow-hidden">
        <div className="relative h-[30rem] flex flex-col items-center w-full">
          ...
          <h2 className="text-center w-3/4 text-xs mt-3 mb-4">
            Choose Gala Education for personalized learning, innovative teaching
            ...
            <div className="flex  shrink-0 overflow-x-auto gap-x-6 2xl:gap-24    sm:justify-center   w-[98%] px-4  sm:w-full">
                ...
                details={
                  <div className="p-6 text-justify">
                    <p className="text-xs leading-loose ">
                      ...
                      dedicated support team to guide you through every step of
                      your academic journey. Whether you&apos;re struggling with
                      a challenging assignment, preparing for an important exam,
                      or simply need advice on how to improve your study habits,
                      our team is here to help.
                    </p>
                    <p className="text-xs leading-loose ">
                      With round-the-clock availability, you can connect with
                      tutors, access a wide range of study materials, and
                      utilize our advanced academic tools whenever you need
                      them. Our support team is committed to ensuring you have
                      all the resources and assistance you need to succeed, no
                      matter the time of day or night. From personalized
                      tutoring sessions to expert advice on course selections,
                      we are dedicated to helping you achieve your academic
                      goals and excel in your studies.
                    </p>
                  </div>
                }
              />
                ...
                details={
                  <div className="p-6 text-justify">
                    <p className="text-xs leading-loose ">
                      ...
                      experience. We meticulously vet each of our instructors to
                      ensure they are the best in the country. Our rigorous
                      selection process includes thorough background checks,
                      professional evaluations, and multiple rounds of
                      interviews to guarantee that only the most knowledgeable
                      and skilled educators join our team. Our instructors are
                      not only experts in their respective fields but also have
                      a proven track record of successful teaching. They bring a
                      wealth of practical experience and academic excellence to
                      the classroom, ensuring that you receive an education that
                      is both comprehensive and relevant.
                    </p>
                    <p className="text-xs leading-loose ">
                      We are committed to providing you with top-notch learning
                      experiences, and that starts with having the best
                      instructors. By choosing our program, you can be confident
                      that you are learning from professionals who are dedicated
                      to your success and are passionate about imparting their
                      knowledge. Rest assured, you are in capable and expert
                      hands, receiving education from the very best in the
                      industry.
                    </p>
                  </div>
                }
              ...
              <Card1
                ...
                details={
                  <div className="p-6 text-justify">
                    <p className="text-xs leading-loose ">
                      At Gala, we offer a groundbreaking approach to education
                      through our customized learning systems. Imagine having
                      lessons and resources specifically designed to match your
                      unique learning style and pace. This is&apos;t just a
                      dream; it&apos;s the reality we provide to all our
                      students. Our state-of-the-art educational tools are the
                      best in the country, crafted to ensure that you not only
                      understand the material but also enjoy the learning
                      process. We understand that every student is different,
                      and that&apos;s why our program adapts to your individual
                      needs, making learning more effective and enjoyable.
                    </p>
                    <p className="text-xs leading-loose ">
                      With our Customized Learning program, you&apos;ll
                      experience a personalized educational journey that keeps
                      you engaged and motivated. Our resources are designed by
                      top educators and utilize the latest technology to make
                      sure you have everything you need to succeed. Join us and
                      discover how our tailored lessons can transform your
                      educational experience. With the best tools at your
                      disposal, you&apos;ll be well-equipped to achieve your
                      academic goals and reach your full potential.
                    </p>
                  </div>
                }
              />
      ...
      <div className="flex flex-col items-center ">
        ...
        <h2 className="text-xs md:w-2/3 w-full px-3 flex text-center py-4">
          ...
          especially those from poor backgrounds. You don&apos;t have to be a
          user to contribute—every donation makes a difference in providing
          ...
          <div className="  py-6 flex flex-col gap-y-3">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-between items-center md:gap-4 mb-4 w-full">
              <p className="text-[12px] leading-[15px] basis-2/3">
                ...
                limit access to quality education. To support students facing
                financial struggles, we offer scholarships, flexible payment
                plans, and need-based grants. Our scholarship program supports
                talented students, while flexible payment plans make tuition
                more manageable. We are committed to ensuring every student can
                pursue their educational goals, regardless of their financial
                situation.
              </p>
            ...
            <button className="border-[1px] md:w-2/5 w-full text-xs text-center font-bold p-2  border-[#030DFE] rounded">
      ...
      <div className="relative flex flex-col sm:flex-row  mt-4  h-fit w-full ">
        <div className="w-full flex  space-y-8   h-fit flex-col items-center">
          ...
          <h1 className="text-center text-xs px-4">
            &ldquo;Our platform offers personalized, AI-driven learning while
            teaching students healthy <br /> digital habits for balanced,
            responsible technology use.&ldquo;
          </h1>
          <div className="hidden md:block">
      ...
      <div className="relative px-1">
          ...
          <div className="w-full py-3">
            <div className="basis-1/2 space-y-2 items-center gap-4 flex flex-col">
              ...
              <h1 className="text-center text-xs w-full px-3 md:w-2/3">
                ...
                progress on our mission to make quality education accessible to
                all. Follow our journey as we continue to make a difference in
                  ...
                  <div className="basis-1/2 flex flex-col h-80">
                    ...
                    <div className="flex sm:flex-row h-full items-center flex-col bg-[#001840] ">
                      ...
                      <div className="basis-1/2 text-[10px] px-2 py-3 flex items-center justify-center text-white">
                        Gala Education is excited to announce the launch of our
                        AI-powered learning platform, offering personalized
                        tutoring and adaptive learning experiences for K12
                        students.
                      </div>
                    </div>
        ...
        <div className="py-12 items-center gap-4 px-3 flex flex-col">
          ...
          <h1 className="text-center text-xs w-full px-3 md:w-2/3">
            ...
            Gala Education is committed to making a positive impact. Join us in
            supporting our mission to transform education across Tanzania.
          </h1>
          <div className="hidden md:block">
        ...
        <div className="py-12 items-center gap-4 flex flex-col">
          ...
          <h1 className="text-center text-xs w-full px-6 md:w-2/3">
            Here you&apos;ll find answers to common questions about Gala Education&apos;s
            services, donations, and how our platform works. Whether you&apos;re
            a student, parent, or supporter, we&apos;ve provided helpful
            information to guide you. If you don&apos;t find what you&apos;re
