...
function Home() {
    return (
        <div>
            <div className="relative w-[100vw] sm:h-[88vh] h-[100vh]">
                <Image
                    src="/gala_home1.jpeg"
                    layout="fill"
                    objectFit="cover"
                ...
                <div className="absolute inset-0 sm:px-[15vw] px-[5vw] sm:pt-[14vh] pt-[4vh] flex sm:flex-row flex-col sm:justify-between">
                    <div>
                        <div className="">
                    ...
                    <div className="bg-white px-5 py-3 w-[90vw] sm:w-[27vw] h-fit rounded-[15px]">
            ...
            <div className="px-20 py-12 flex flex-col items-center">
                <div className="relative left-0  w-screen h-[30rem]">
                    <svg
                        width="408"
                        height="394"
                        className="absolute top-[18rem] left-[9rem]"
                        viewBox="0 0 408 394"
                        fill="none"
                    ...
                    <svg
                        ...
                        height="394"
                        viewBox="0 0 407 394"
                        className="absolute top-[18rem] right-[9rem]"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <path
                    ...
                    <div className="absolute top-0 left-0 h-[40vh]  flex flex-col items-center  w-screen">
                        ...
                        <h2>unlocking every student's full potential."</h2>
                    </div>
                </div>
            </div>
        </div>
