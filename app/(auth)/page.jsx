...
import 
Card from "@/src/components/home/card/RegisterCard";
    ...
    <>
      ...
      <div className="relative flex items-center w-full px-6 ">
        <div className=" w-full mt-1 py-4 flex gap-5 items-center justify-center flex-col h-fit">
          ...
          <Animator delay={0.4} className="w-full flex justify-center">
            <h2 className="text-center w-full px-3 md:w-2/3 text-xs">Our clients&apos; feedback is at the heart of what we do. We’re proud to share their experiences and the positive impact our platform has had on their learning journey. Here’s what they have to say about Gala Education.</h2>
          </Animator>
          <div className="hidden md:block">
      ...
      <div className="relative w-full h-[30rem] md:h-[25rem] overflow-hidden">
        <div className="relative h-[30rem] flex flex-col items-center w-full">
          ...
          <Animator direction="top" className="w-full flex justify-center" delay={0.4}>
            <h2 className="text-center w-3/4 text-xs mt-3 mb-4">
              Choose Gala Education for personalized learning, innovative teaching methods, and a commitment to
              <br />
      ...
      <div className="flex flex-col items-center ">
        ...
        <div className="relative flex flex-col gap-4 sm:flex-row mt-3 h-fit sm:h-[37rem] w-full ">
          <Animator delay={0.6} direction="right" className="w-full flex justify-center">
          ...
          <div className="md:w-1/2 w-full ">
            <Animator delay={0.6} direction="left" className="w-full flex justify-center">
      ...
      <div className=" flex justify-center px-6">
        <Animator delay={0.2} direction="top" className="w-full flex justify-center">
      ...
      <div className="relative px-1">
                  ...
                  <Animator direction="up" delay={1.2} className="basis-1/2">
                    <div className="basis-1/2 flex flex-col h-80">
                      ...
                      <div className="flex sm:flex-row h-full items-center flex-col bg-[#001840] ">
                        <div className="basis-1/2 text-white sm:text-lg md:text-2xl text-lg p-4 font-black">Gala Education Launches AI-Powered Learning Platform</div>
        ...
        <div className="py-12 items-center gap-4 px-3 flex flex-col">
          ...
          <Animator direction="up" delay={0.8} className="w-full flex justify-center">
            <h1 className="text-center text-xs w-full px-3 md:w-2/3">Stay up-to-date with our latest initiatives and activities! From community outreach programs to educational workshops and events, Gala Education is committed to making a positive impact. Join us in supporting our mission to transform education across Tanzania.</h1>
          </Animator>
          <div className="hidden md:block">
