        ...
        <div className="absolute inset-0 p-48 w-full  gap-12 flex md:flex-row flex-col lg:justify-between">
          <div>
            <div className="">
              ...
              <h1 className="text-white sm:text-[64px] mt-10 text-[40px]  sm:leading-[70px] leading-[35px] font-black">Gala</h1>
              <h1 className="text-white sm:text-[64px] text-[40px]  sm:leading-[70px] leading-[35px] font-black">Education</h1>
            </div>
            <h2 className="text-white font-bold sm:leading-[30px] leading-[15px] sm:text-[20px] text-[10px] pt-[4vh]">
              &ldquo;Empowering minds,shaping <br /> futures - Gala Education, your
              <br /> pathway to success.&ldquo;
            </h2>
            <h2 className="text-white font-bold leading-[30px] sm:text-[20px] text-[10px] sm:pt-[4vh] pt-[2vh]">Join Now to get 50% off</h2>
          </div>
          <div className="bg-white px-5 py-3 w-[90vw] lg:w-[50vw] h-fit rounded-[15px]">
            <h1 className="font-black sm:text-xs text-[10px]">Are you interested in a session and want to know more?</h1>
            <h2 className="font-normal sm:text-xs text-[8px]">
              Fill out the form and you will be contacted as soon as <br /> possible by our office
            </h2>
            <div className="grid grid-cols-2 homepage-info-form gap-2 mt-3">
              <input placeholder="Name*" className="bg-[#001840] placeholder:text-[#475873] py-1 px-2 rounded-[5px]" />
              <input placeholder="Email*" className="bg-[#001840] placeholder:text-[#475873] py-1 px-2 rounded-[5px]" />
              <input placeholder="Name*" className="bg-[#001840] placeholder:text-[#475873] py-1 px-2 rounded-[5px]" />
              <input placeholder="Email*" className="bg-[#001840] placeholder:text-[#475873] py-1 px-2 rounded-[5px]" />
            ...
            <div>
              <div className="space-x-1">
                <Checkbox />
                <span className="text-[8px] sm:leading-[5px] leading-[2px]">I authorize the processing of personal data for purposes related to the performance of institutional activities * ( Information)</span>
              </div>
              <div className="space-x-1">
                <Checkbox />
                <span className="text-[8px] leading-[5px]">I authorize the processing of data for sending informative material (Information)</span>
              </div>
            </div>
            <div className="py-4">
              <Button className="!bg-[#800000] !text-white sm:!px-5 !px-3 sm:!py-6 !py-2">Send your request</Button>
            </div>
            <textarea rows={2} className="!bg-[#001840] text-white p-2 w-full rounded-[5px]" />
          </div>
        </div>
      </div>
      <div className="px-20  flex flex-col items-center">
        <div className="relative w-screen h-[45rem] overflow-hidden">
          <svg viewBox="0 0 408 394" className="absolute sm:top-[18rem] top-[6rem] sm:left-[9rem] left-[6rem] w-[150px] h-[192px] sm:w-[300px] sm:h-[288px] md:w-[408px] md:h-[394px]" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M71.158 0.328125L111.576 40.7188L83.0182 69.3125C49.6225 102.75 49.6225 157.125 83.0182 190.563L204.117 311.734C237.512 345.172 291.819 345.172 325.215 311.734C358.611 278.297 358.611 223.922 325.215 190.484L279.647 144.859L319.909 104.469L365.477 150.094C421.111 205.797 421.111 296.422 365.477 352.125C337.699 379.938 301.105 393.922 264.588 393.922C228.071 393.922 191.476 380.016 163.698 352.125L42.6 230.875C-13.0335 175.172 -13.0335 84.5469 42.6 28.8438L71.158 0.328125Z" fill="#0F1F3C" fillOpacity="0.1" />
          </svg>
          <svg viewBox="0 0 407 394" className="absolute top-5 sm:left-0 left-[2rem] w-[150px] h-[192px] sm:w-[300px] sm:h-[288px] md:w-[407px] md:h-[394px]" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M41.757 41.7969C97.3904 -13.9063 187.902 -13.9063 243.536 41.7969L364.556 162.969C420.19 218.672 420.19 309.297 364.556 365L335.998 393.594L295.658 353.203L324.216 324.609C357.612 291.172 357.612 236.797 324.216 203.359L203.117 82.1094C169.722 48.6719 115.415 48.6719 82.019 82.1094C48.6234 115.547 48.6234 169.922 82.019 203.359L137.653 259.062L97.3124 299.453L41.6789 243.75C-13.8766 188.125 -13.8766 97.5 41.757 41.7969Z" fill="#0F1F3C" fillOpacity="0.1" />
          </svg>
          <svg viewBox="0 0 407 394" className="absolute sm:top-[18rem] top-[22rem] sm:right-[4rem] right-[3.5rem] w-[150px] h-[192px] sm:w-[300px] sm:h-[288px] md:w-[407px] md:h-[394px]" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M41.757 352.203C97.3904 407.906 187.902 407.906 243.536 352.203L364.556 231.031C420.19 175.328 420.19 84.7031 364.556 29L335.998 0.40625L295.658 40.7969L324.216 69.3906C357.612 102.828 357.612 157.203 324.216 190.641L203.117 311.891C169.722 345.328 115.415 345.328 82.019 311.891C48.6234 278.453 48.6234 224.078 82.019 190.641L137.653 134.938L97.3124 94.5469L41.6789 150.25C-13.8766 205.875 -13.8766 296.5 41.757 352.203Z" fill="#0F1F3C" fillOpacity="0.1" />
          </svg>
          <svg viewBox="0 0 408 394" className="absolute sm:top-5 top-[16rem] right-0 w-[150px] h-[192px] sm:w-[300px] sm:h-[288px] md:w-[408px] md:h-[394px]" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M71.158 393.672L111.576 353.281L83.0182 324.687C49.6225 291.25 49.6225 236.875 83.0182 203.437L204.117 82.2656C237.512 48.8281 291.819 48.8281 325.215 82.2656C358.611 115.703 358.611 170.078 325.215 203.516L279.647 249.141L319.909 289.531L365.477 243.906C421.111 188.203 421.111 97.5781 365.477 41.875C337.699 14.0625 301.105 0.078125 264.588 0.078125C228.071 0.078125 191.476 13.9844 163.698 41.875L42.6 163.125C-13.0335 218.828 -13.0335 309.453 42.6 365.156L71.158 393.672Z" fill="#0F1F3C" fillOpacity="0.1" />
          </svg>

          <div className="absolute top-0 left-0  sm:h-[35rem] bg-black/10 h-40vh   flex flex-col items-center  py-8  w-screen">
            <h1 className="font-black text-[20px] sm:text-[40px]">Why choose our platform?</h1>
            <h2 className="text-[10px] sm:text-[15px] text-center py-6">
              &ldquo;Choose Gala Education for personalized learning, innovative teaching methods, and a commitment to
              <br />
            ...
            <div className="flex  gap-3 2xl:gap-24  h-[48rem] sm:h-[50rem] sm:justify-center  w-[98%] px-4  sm:w-full">
              <Card1 image={"/card1img1.jpeg"} title={"Comprehensive Support"} desc={"Access 24/7 study assistance, academic tools, and a dedicated support team to guide you."} />
              <Card1 image={"/card1img2.jpeg"} title={"Expert Instructors"} desc={"Learn from highly qualified educators with years of experience."} />
              <Card1 image={"/card1img3.jpeg"} title={"Customized Learning"} desc={"Tailored lessons and resources that adapt to your learning style and pace."} />
            </div>
            <div>
        ...
        <div className="relative w-full max-w-screen-2xl mx-auto px-4 py-6 sm:py-10 flex flex-col md:flex-row">
          <div className="md:w-1/2 w-full flex flex-col items-center gap-7 p-4">
            <h1 className="text-black w-full font-bold text-center text-xl sm:text-[40px]">Register with us!</h1>
            <h3 className="text-center text-sm sm:text-base leading-relaxed px-4">&ldquo;Join Gala Education today - register as a teacher or student and unlock endless learning opportunities!&ldquo;</h3>
            <div className="flex flex-col sm:flex-row justify-center gap-5 w-full">
              <RegisterCard title={"Register as teacher"} image={"/register_teacher.jpeg"} link={"/teacher"} desc={"Become part of our team of educators and help deliver exceptional learning experiences."} />
              <RegisterCard title={"Register as student"} image={"/register_student.jpeg"} link={"/student"} desc={"Join our community of learners and be part of the journey to excellence in education!"} />
            </div>
          </div>
          <div className="md:w-1/2 w-full relative h-[50vh] md:h-auto flex justify-center items-center mt-8 md:mt-0">
            <div className="relative w-full max-w-md">
              <Image alt="Donation image" src={"/donate1.jpeg"} fill className="absolute inset-0 object-cover rounded-br-[100px] bg-blue-400" />
              <div className="relative z-10 bg-white p-6 mt-[40%] md:mt-[20%] mx-4 border rounded-lg shadow-lg">
                <h1 className="text-xl font-bold mb-4">Donate today to support underfunded schools</h1>
                <p className="text-sm text-gray-600 mb-4">Join our community and make a difference! Your donation supports quality education and empowers lives. Together, we can create a brighter future. Every contribution counts - be part of something impactful today!</p>
                <button className="w-full md:w-auto border border-blue-600 text-blue-600 font-bold py-2 px-4 rounded-md hover:bg-blue-50 transition-colors">Donate</button>
              </div>
            </div>
          </div>
        </div>
        <div className="">
          <div className="relative w-screen min-h-[100vh] ">
            <svg className="w-[250px] md:w-[300px] h-[250px] md:h-[300px] my-[90px] mx-[20px] absolute -top-[26px] -left-[18px]" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_101_202)">
                ...
                <path
                  ...
                  fillOpacity="0.06"
                />
                <path d="M161.29 233.871V274.194V282.258V290.323H338.71V282.258V274.194V201.613H290.323V274.194H274.194V169.355H225.806V274.194H209.677V233.871H161.29ZM306.452 217.742H322.581V274.194H306.452V217.742ZM241.935 185.484H258.065V274.194H241.935V185.484ZM193.548 274.194H177.419V250H193.548V274.194Z" fill="black" fillOpacity="0.06" />
              </g>
              <defs>
            ...
            <svg className="w-[250px] md:w-[350px] h-[250px] md:h-[350px] my-[90px] mx-[20px] absolute top-0 right-0" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_101_234)">
                <path
        ...
        <div className="relative flex flex-col sm:flex-row  mt-4 h-[100vh] w-screen">
          <div className="absolute left-0 top-0 w-full">
            <svg className="sm:w-[250px] sm:h-[250px] w-[248px] h-[248px] absolute -top-[50vh]" viewBox="0 0 496 496" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_101_211)">
                ...
                <path
                  ...
                  fillOpacity="0.1"
                />
                <path d="M256 168C256 119.48 216.52 80 168 80C119.48 80 80 119.48 80 168C80 216.52 119.48 256 168 256C216.52 256 256 216.52 256 168ZM96 168C96 128.296 128.296 96 168 96C207.704 96 240 128.296 240 168C240 207.704 207.704 240 168 240C128.296 240 96 207.704 96 168Z" fill="black" fillOpacity="0.1" />
                <path d="M242.341 349.657L253.654 338.344L237.657 322.346L226.343 333.66L242.341 349.657Z" fill="black" fillOpacity="0.1" />
                <path d="M322.34 237.661L338.338 253.658L349.651 242.345L333.654 226.347L322.34 237.661Z" fill="black" fillOpacity="0.1" />
              </g>
              <defs>
            ...
            <svg className="md:w-[512px] w-[256px] h-[256px] sm:h-[512px] absolute right-10 sm:top-[0] top-[50vh]" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <div className="absolute left-0 -top-[200px] w-full">
            <svg className="sm:w-[250px] sm:h-[250px] w-[150px] h-[150px]  !-z-10" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fillOpacity="0.1"
              />
              <path d="M228 84H72C70.2 84 69 85.2 69 87V273C69 274.8 70.2 276 72 276H228C229.8 276 231 274.8 231 273V87C231 85.2 229.8 84 228 84ZM225 270H75V90H225V270Z" fill="black" fillOpacity="0.1" />
              <path d="M111 195H189C194.1 195 198 191.1 198 186V108C198 102.9 194.1 99 189 99H111C105.9 99 102 102.9 102 108V186C102 191.1 105.9 195 111 195ZM150 153C140.1 153 132 144.9 132 135C132 125.1 140.1 117 150 117C159.9 117 168 125.1 168 135C168 144.9 159.9 153 150 153ZM150 159C153.3 159 156.3 158.4 159 157.2C174 161.1 184.5 173.7 185.7 189H114C115.2 173.7 126 161.1 140.7 157.2C143.7 158.4 146.7 159 150 159ZM108 108C108 106.2 109.2 105 111 105H189C190.8 105 192 106.2 192 108V186C192 186.6 192 186.9 191.7 187.2C189.9 171.9 180 158.7 165.6 153C170.7 148.5 174 142.2 174 135C174 121.8 163.2 111 150 111C136.8 111 126 121.8 126 135C126 142.2 129.3 148.8 134.4 153C120 158.7 110.1 171.9 108.3 187.2C108 186.9 108 186.6 108 186V108Z" fill="black" fillOpacity="0.1" />
              <path d="M90 216H210C211.8 216 213 214.8 213 213C213 211.2 211.8 210 210 210H90C88.2 210 87 211.2 87 213C87 214.8 88.2 216 90 216Z" fill="black" fillOpacity="0.1" />
              <path d="M90 231H210C211.8 231 213 229.8 213 228C213 226.2 211.8 225 210 225H90C88.2 225 87 226.2 87 228C87 229.8 88.2 231 90 231Z" fill="black" fillOpacity="0.1" />
              <path d="M90 246H210C211.8 246 213 244.8 213 243C213 241.2 211.8 240 210 240H90C88.2 240 87 241.2 87 243C87 244.8 88.2 246 90 246Z" fill="black" fillOpacity="0.1" />
              <path d="M90 261H210C211.8 261 213 259.8 213 258C213 256.2 211.8 255 210 255H90C88.2 255 87 256.2 87 258C87 259.8 88.2 261 90 261Z" fill="black" fillOpacity="0.1" />
            </svg>
          </div>
      ...
      <div className="relative">
        <div className="relative flex justify-center ">
          <svg className="sm:w-[350px] w-[150px]   sm:h-[350px] h-[150px] absolute -top-64 -z-[100] sm:-left-[5rem] left-0" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M80 45C77 45 75 47 75 50V85C75 88 77 90 80 90C83 90 85 88 85 85V50C85 47 83 45 80 45Z" fill="black" fillOpacity="0.1" />
            <path d="M80 100C77 100 75 102 75 105V110C75 113 77 115 80 115C83 115 85 113 85 110V105C85 102 83 100 80 100Z" fill="black" fillOpacity="0.1" />
            <path d="M420 90C423 90 425 88 425 85V50C425 47 423 45 420 45C417 45 415 47 415 50V85C415 88 417 90 420 90Z" fill="black" fillOpacity="0.1" />
            <path d="M420 115C423 115 425 113 425 110V105C425 102 423 100 420 100C417 100 415 102 415 105V110C415 113 417 115 420 115Z" fill="black" fillOpacity="0.1" />
            <path
              ...
              fillOpacity="0.1"
            />
            <path d="M420 385C417 385 415 387 415 390V425C415 428 417 430 420 430C423 430 425 428 425 425V390C425 387 423 385 420 385Z" fill="black" fillOpacity="0.1" />
            <path d="M420 440C417 440 415 442 415 445V450C415 453 417 455 420 455C423 455 425 453 425 450V445C425 442 423 440 420 440Z" fill="black" fillOpacity="0.1" />
            <path d="M80 385C77 385 75 387 75 390V425C75 428 77 430 80 430C83 430 85 428 85 425V390C85 387 83 385 80 385Z" fill="black" fillOpacity="0.1" />
          ...
          <div className="self-center flex flex-col sm:flex-row px-6 rounded-md shadow-md shadow-black w-[70vw] 2xl:w-[50vw] bg-[#F3F2F2] my-10">
            <div className="basis-2/3  py-2 flex flex-col gap-y-4">
              ...
              <p className="text-xs">At Gala Education, we understand that financial barriers can hinder access to quality education. To support students facing financial struggles, we offer a range of financial assistance options, including scholarships, flexible payment plans, and need-based grants. Our scholarship program is designed to recognize and support talented students who may not have the means to afford our courses. Additionally, we provide flexible payment plans that allow students to spread their tuition payments over time, making it easier to manage their finances. We are committed to ensuring that every student has the opportunity to pursue their educational goals, regardless of their financial situation.</p>
            ...
            <div className="basis-1/3 flex sm:gap-x-5  gap-x-3 justify-between sm:justify-normal py-4 items-center">
              <svg className="w-[50px] sm:w-[70px] h-[50px] sm:h-[50px]" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_85_267)">
                  <path
              ...
              <svg className="w-[50px] sm:w-[70px] h-[50px] sm:h-[50px]" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  fill="black"
                />
                <path d="M66.4364 21.5698H65.249L64.4226 22.4663L64.2854 23.3628L64.9149 23.6984L66.4364 21.5698Z" fill="black" />
                <path d="M67.758 21.2773L68.4994 21.0998L67.758 20.4241V21.2773Z" fill="black" />
                <path d="M66.8943 21.2773H67.3776V20.5389H67.0659V20.1123H66.3678H65.6532L64.6195 20.5389L64.4226 21.0536L65.2296 21.2773H66.8943Z" fill="black" />
                <path d="M63.8826 18.7444L64.1735 17.6003L63.3202 17.4004L62.379 17.8464L62.9622 19.0353L63.8826 18.7444Z" fill="black" />
                <path d="M69.5286 22.1336C69.4496 21.9382 69.3735 21.7428 69.2959 21.5474L69.0602 21.798L69.4943 22.1604L69.5286 22.1336Z" fill="black" />
                <path d="M69.727 22.6422L68.747 22.3528H68.6575V23.0017L68.9692 23.4536H69.9985C69.9075 23.1836 69.8269 22.9092 69.727 22.6422Z" fill="black" />
                <path d="M59.063 11.9752V12.6927H60.8351L61.1991 12.2005V12.1975V11.6411H60.7188H59.9177L59.8491 11.9096H59.063V11.9752Z" fill="black" />
                <path d="M67.1554 21.9159C67.1554 22.2694 67.1554 22.7572 67.1554 22.7572L67.4641 22.7005L67.8266 22.6349L68.3666 22.2873V21.5713H67.1554C67.1554 21.6056 67.1554 21.7473 67.1554 21.9159Z" fill="black" />
                <path d="M67.2672 23.1166L67.1554 23.3836L66.6154 23.4313L66.4364 24.2144H67.582L67.8893 23.9057L68.0951 23.6983V23.0017L67.6058 23.0688L67.2672 23.1166Z" fill="black" />
                <path d="M59.063 14.0816L59.4031 14.4859L61.1737 14.3725C61.1737 14.3725 61.2409 13.5894 61.1737 13.5894C61.1066 13.5894 60.322 13.7236 60.322 13.7236L59.063 14.0816Z" fill="black" />
              </svg>
              <svg className="w-[50px] sm:w-[70px] h-[50px] sm:h-[50px]" viewBox="0 0 68 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div className="relative py-4">
          <svg className="w-[450px] h-[450px] absolute -top-[70px] right-[20vw]" viewBox="0 0 737 560" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
            ...
            <path
              ...
              fillOpacity="0.08"
            />
            <path d="M384.167 280H656.167C660.967 280 664.167 276.8 664.167 272V80C664.167 75.2 660.967 72 656.167 72H384.167C379.367 72 376.167 75.2 376.167 80V272C376.167 276.8 379.367 280 384.167 280ZM392.167 88H648.167V264H392.167V88Z" fill="black" fillOpacity="0.08" />
            <path d="M520.167 104C480.167 104 448.167 136 448.167 176C448.167 216 480.167 248 520.167 248C560.167 248 592.167 216 592.167 176C592.167 136 560.167 104 520.167 104ZM520.167 232C488.967 232 464.167 207.2 464.167 176C464.167 144.8 488.967 120 520.167 120C551.367 120 576.167 144.8 576.167 176C576.167 207.2 551.367 232 520.167 232Z" fill="black" fillOpacity="0.08" />
