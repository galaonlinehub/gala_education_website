...
function Home() {
  ...
  return (
    <div className="relative w-screen max-w-screen-2xl mx-auto h-full overflow-hidden space-y-10">
      ...
      <div className="relative flex flex-col gap-4 md:gap-12 sm:flex-row px-12 h-fit sm:h-[30rem] w-full ">
        <div className="relative w-full sm:w-1/2 mt-14 h-full max-sm:p-2">
          <VideoPlayer videoSrc="/videos/gala_intro.mp4" />
        </div>
        <div className="md:w-1/2 w-full">
          <div className="flex flex-col gap-4 w-full h-3/4">
            <span className="mt-16 text-center font-bold text-xl">Our Story</span>
      ...
      <div className="relative flex items-center  w-full h-[50rem] ">
        <div className=" w-full mt-12 py-4 flex gap-5 items-center justify-center flex-col h-fit">
          ...
          <div className="sm:grid flex  max-sm:w-[98%] overflow-x-auto sm:grid-cols-3 gap-20 ">
      ...
      <div className="relative  max-sm:w-screen h-[50rem] sm:h-[35rem]  w-full max-w-screen-2xl mx-auto mt-4 px-2 sm:px-4 py-6 sm:py-10 flex flex-col md:flex-row">
        <div className=" w-full flex flex-col items-center gap-3 p-4">
          <h1 className="font-black w-full text-center lg:text-4xl sm:text-[40px]">Register with us!</h1>
          <h3 className="text-center text-sm md:w-1/3 w-full mb-4 sm:text-sm leading-relaxed sm:px-4 ">Join Gala Education today - register as a teacher or student and unlock endless learning opportunities!</h3>
      ...
      <div className="relative w-full h-[25rem] overflow-hidden">
        <div className="relative h-[30rem] flex flex-col items-center w-full">
          ...
          <h2 className="text-[10px] sm:text-sm text-center py-4">
      ...
      <div className="relative flex justify-center ">
        <div className="self-center rounded-[15px] flex flex-col sm:flex-row px-6  shadow-[0px_4px_4px_rgba(0,0,0,0.6)] w-[72rem] my-10">
      ...
      <div className="relative flex flex-col sm:flex-row  mt-4  h-fit w-full ">
        <div className="w-full flex py-8 space-y-8   h-fit flex-col items-center">
      ...
      <div className="relative">
            ...
            <div className="basis-1/2 space-y-2 items-center gap-4 flex flex-col">
              ...
              <div className="flex flex-col shadow-xl p-6 ">
                <div className="flex gap-2 flex-col sm:flex-row ">
                  ...
                  <div className="basis-1/2 h-80 justify-between flex flex-col gap-1">
        ...
        <div className="py-12 items-center gap-4 flex flex-col">
          ...
          <h1 className="text-center text-sm w-2/3">Stay up-to-date with our latest initiatives and activities! From community outreach programs to educational workshops and events, Gala Education is committed to making a positive impact. Join us in supporting our mission to transform education across Tanzania.</h1>
