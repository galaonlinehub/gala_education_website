...
import CountDownCard from "@/src/components/ui/timer";
      ...
      <div className="relative w-screen max-w-screen-2xl mx-auto h-[60rem] sm:h-[44rem] overflow-hidden pt-[-6rem]">
        ...
        <div className="absolute inset-0 sm:py-24 py-12 w-full sm:px-24 px-2  flex md:flex-row flex-col lg:justify-between max-sm:gap-5">
          <div className={""}>
            ...
            <div
              className={
                "rounded-[4rem] py-[2px] px-4 mt-[2rem] flex gap-2 items-center justify-between bg-[#00184080]/50 border-white border-[1px]  sm:w-2/3 w-full"
              }
            >
              ...
              <input
                ...
                className={
                  "bg-transparent placeholder-white/85 placeholder:text-xs text-white focus:placeholder-white/85 border-none focus:outline-none"
                }
              />
              <FaSearch className={"text-white"} />
              <span
                className={
                  "h-10 w-10 flex items-center justify-center rounded-full text-white text-center bg-purple-600"
                }
              >
                E
              </span>
          ...
          <div className="relative w-full h-full  place-items-center">
            ...
            <div className="absolute  sm:bottom-24 sm:left-[2rem] -bottom-[5rem] left-3 w-[15rem] sm:w-[20rem] !z-10 bg-white p-6  mxp-4 border rounded-lg shadow-lg">
              ...
              <p className="sm:text-sm text-xs text-gray-600 mb-4 ">
                Join our community and make a difference! Your donation supports
                quality education and empowers lives. Together, we can create a
                brighter future. Every contribution counts - be part of
                something impactful today!
              </p>
              <button
      ...
      <div className="relative flex flex-col gap-4 sm:flex-row mt-14 h-fit sm:h-[45rem] w-full ">
        ...
        <div className="relative w-full sm:w-1/2 h-full max-sm:p-2">
          ...
          <Image
            ...
            height={1080}
            quality={75}
            className="border-[14px] top-[5rem]  left-[6rem] w-[542px] h-[378px] object-cover  sm:absolute  border-white"
          />
        </div>
        <div className=" sm:px-20 px-2 sm:w-1/2  w-full space-y-6 sm:py-[15vh]">
          ...
          <h2 className="text-[12px]">
            At Gala Education, we offer personalized one-on-one tutoring in
            subjects like math, science, English, social studies, foreign
            languages, and more, with flexible scheduling tailored to your
            child&apos;s learning needs. Our experienced and qualified tutors
            provide targeted help with homework, test preparation, and
            standardized exams, as well as support for students with special
            needs. We ensure each student receives focused attention to build
            academic confidence and succeed in their studies. All you need is a
            device and a stable internet connection to access our tutoring
            sessions online
          </h2>
      ...
      <div className="relative">
              ...
              <div className="flex gap-2 flex-col sm:flex-row ">
                <div className="basis-1/2 flex flex-col  ">
                  ...
                  <div className="flex sm:flex-row flex-col bg-[#001840] ">
                    <div className="basis-1/2 text-white sm:text-lg text-lg p-4 font-black">
                  ...
                  <button className="border border-[#030DFE] mt-4  sm:w-1/4 w-fit rounded p-1 text-xs">
                    Read the Article
                  </button>
                </div>
        ...
        <div className={"py-4"}>
          ...
          <div className="relative py-16">
            <svg
              className={
                "sm:w-[300px] w-[250px] sm:h-[300px] h-[250px] -z-[90] absolute top-0 -left-28"
              }
              viewBox="0 0 460 418"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <svg
              className="sm:w-[300px] w-[250px] sm:h-[300px] h-[250px] -z-[90] absolute sm:top-0 bottom-0 sm:right-10 right-14"
              viewBox="0 0 460 418"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
