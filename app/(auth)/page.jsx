          ...
          <div className="md:w-1/2 w-full mb-20">
            <div className="flex flex-col gap-4 w-full h-3/4">
              ...
              <div className="text-xs leading-loose text-justify md:text-left ">
                ...
                lack of qualified teachers and resources. Gala Education was
                born from a deep desire to change this reality, offering hope
                through high-quality online tutoring for Primary, Secondary, and
                High School students. We not only provide jobs for teachers but
                also reinvest our profits into building classrooms, libraries,
                hiring part-time instructors and more, bringing dreams within
                reach for countless children across Tanzania. Additionally, our
                platform offers a variety of short courses designed to equip
                young Tanzanians with practical, self-employable skills taught
                by experts in various fields. Join us in making a profound
        ...
        <div className="relative flex items-center w-full px-6 ">
          <div className=" w-full mt-1 py-4 flex gap-5 items-center justify-center flex-col h-fit">
            ...
            <h2 className="text-center w-full px-3 md:w-2/3 text-xs">
              ...
              platform has had on their learning journey. Here’s what they have
              to say about Gala Education.
            </h2>
            <div className="hidden md:block">
                  ...
                  details={
                    <div className="p-6 text-justify">
                      <p className="text-xs leading-loose ">
                        ...
                        of your academic journey. Whether you&apos;re struggling
                        with a challenging assignment, preparing for an
                        important exam, or simply need advice on how to improve
                        your study habits, our team is here to help.
                      </p>
                      <p className="text-xs leading-loose ">
                  ...
                  details={
                    <div className="p-6 text-justify">
                      <p className="text-xs leading-loose ">
                        ...
                        experience. We meticulously vet each of our instructors
                        to ensure they are the best in the country. Our rigorous
                        ...
                        have a proven track record of successful teaching. They
                        bring a wealth of practical experience and academic
                        excellence to the classroom, ensuring that you receive
                        an education that is both comprehensive and relevant.
                      </p>
                      <p className="text-xs leading-loose ">
                  ...
                  details={
                    <div className="p-6 text-justify">
                      <p className="text-xs leading-loose ">
                        ...
                        lessons and resources specifically designed to match
                        your unique learning style and pace. This is&apos;t just
                        a dream; it&apos;s the reality we provide to all our
                        ...
                        and that&apos;s why our program adapts to your
                        individual needs, making learning more effective and
                        enjoyable.
                      </p>
                      <p className="text-xs leading-loose ">
                        ...
                        sure you have everything you need to succeed. Join us
                        and discover how our tailored lessons can transform your
            ...
            <div className="  py-6 flex flex-col gap-y-3">
              ...
              <div className="flex flex-col md:flex-row gap-6 justify-between items-center md:gap-4 mb-4 w-full">
                <p className="text-[12px] leading-[15px] basis-2/3">
                  ...
                  more manageable. We are committed to ensuring every student
                  can pursue their educational goals, regardless of their
                  financial situation.
                </p>
        ...
        <div className="relative px-1">
            ...
            <div className="w-full py-3">
              <div className="basis-1/2 space-y-2 items-center gap-4 flex flex-col">
                ...
                <h1 className="text-center text-xs w-full px-3 md:w-2/3">
                  ...
                  to all. Follow our journey as we continue to make a difference
          ...
          <div className="py-12 items-center gap-4 px-3 flex flex-col">
            ...
            <h1 className="text-center text-xs w-full px-3 md:w-2/3">
              ...
              in supporting our mission to transform education across Tanzania.
            </h1>
            <div className="hidden md:block">
          ...
          <div className="py-12 items-center gap-4 flex flex-col">
            ...
            <h1 className="text-center text-xs w-full px-6 md:w-2/3">
              ...
              provided helpful information to guide you. If you don&apos;t find
