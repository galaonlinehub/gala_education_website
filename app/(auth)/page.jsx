    ...
    <div>
            ...
            <div>
              <div className="space-x-1">
                ...
                <span className="text-[8px] sm:leading-[5px] leading-[2px]">
                  I authorize the processing of personal data for purposes
              ...
              <div className="space-x-1">
                ...
                <span className="text-[8px] leading-[5px]">
                  I authorize the processing of data for sending informative
      ...
      <div className="px-20  flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row w-screen">
          ...
          <div className={"sm:basis-1/2   h-full flex w-full items-center"}>
        ...
        <div className="relative flex flex-col sm:flex-row  mt-4 h-[100vh] w-screen">
          ...
          <div className=" sm:px-20 px-2 sm:w-3/4 w-full space-y-3 sm:py-[15vh]">
            ...
            <h2 className="text-sm">
              ...
              academic confidence and succeed in their studies. All you need is
              a device and a stable internet connection to access our tutoring
              sessions online
            </h2>
      ...
      <div className="relative">
        ...
        <div className={"py-4"}>
          ...
          <div className="relative py-16">
            ...
            <svg
              className="sm:w-[300px] w-[250px] sm:h-[300px] h-[250px] -z-[90] absolute sm:top-0 bottom-0 sm:-right-28 right-14"
              viewBox="0 0 460 418"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <div
              className={
                "flex flex-col sm:flex-row justify-around items-center gap-y-2 gap-x-4"
              }
            >
              <Events
                img={"/events1.jpeg"}
