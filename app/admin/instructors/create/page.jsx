            ...
            <Card className="!border-0 -mx-5 lg:-mx-0 mt-3">
                <div className="flex flex-col gap-2 justify-center items-center w-full mb-6">
                    ...
                    <span className="font-medium text-[12px] w-full text-center">
                        This will create a special pass instructor with a
                        defined special pass, user account will be active upon
                        email verification and setting password.
                    </span>
                </div>
                {registerError && (
                    <div
                        ...
                        <Form.Item
                            ...
                            rules={[
                                ...
                                },
                                {
                                    len: 20,
                                    message:
                                        "NIDA number must be exactly 20 digits",
                                },
                            ]}
                        >
                            <Input
                            ...
                            rules={[
                                {
                                    required: true,
                                    message:
                                        "Please choose the user pass duration",
                                },
                            ]}
                        >
                            <Select
                    ...
                    <div className="flex flex-col w-full lg:w-4/12">
                        ...
                        >
                            <Upload
                                ...
                                beforeUpload={beforeUpload}
                                onChange={(info) =>
                                    handleFileChange(info, "transcript")
                                }
                        ...
                        >
                            <Upload
                                ...
                                beforeUpload={beforeUpload}
                                onChange={(info) =>
                                    handleFileChange(info, "oLevelCertificate")
                                }
                        ...
                        <Form.Item name="aLevelCertificate">
                            <Upload
                                ...
                                beforeUpload={beforeUpload}
                                onChange={(info) =>
                                    handleFileChange(info, "aLevelCertificate")
                                }
