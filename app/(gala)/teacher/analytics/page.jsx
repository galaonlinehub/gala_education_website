        ...
        <div className="w-full lg:w-2/3">
            ...
            <div className="w-full sm:w-1/2 border-2 border-blue-700 rounded-xl p-3">
              ...
              <div className="flex flex-col">
                {studentAttendance.map((item, index) => (
                  <div key={index} className="flex justify-between gap-4 text-xs items-center p-1">
                    ...
                    <Progress percent={item.progress} strokeColor={item.color} className="w-24 sm:w-32 md:w-40" />
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="overflow-x-auto">
            {tableItems.map((item, i) => (
              <div key={i} className="rounded-md p-2 font-semibold flex text-xs justify-between items-center text-white bg-[#001840] mb-2 min-w-[600px]">
                ...
                <span className="w-2/12 text-center">{item.members} Members</span>
            ...
            <div className="p-4 sm:p-6">
              ...
              <form className="space-y-4">
                <div className="text-xs text-white">
                  ...
                  <select id="analytics" name="analytics" className="mt-1 block w-full bg-[#001840] rounded-md border border-white p-2 text-xs shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div className="text-xs text-white">
                  ...
                  <select id="subject" name="subject" className="mt-1 block w-full bg-[#001840] rounded-md border border-white p-2 text-xs shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
