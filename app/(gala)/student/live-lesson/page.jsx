            ...
            <div className="p-6">
              ...
              <form className="space-y-4 text-xs">
                <div>
                  ...
                  <input type="text" id="fullName" name="fullName" className="mt-1 bg-[#001840] block w-full p-2 border-white border shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" placeholder="Enter your full name" />
                </div>
                <div>
                  <label htmlFor="classCode" className="block text-sm font-medium text-white">
                    Class ID/Code
                  </label>
                  <input type="text" id="classCode" name="classCode" className="mt-1 bg-[#001840] block w-full p-2 border-white border shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" placeholder="Enter class code" />
                </div>
                <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-white">
                    Subject
                  </label>
                  <select id="subject" name="subject" className="mt-1 bg-[#001840] block w-full p-2 border-white border shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div>
                  ...
                  <input type="date" id="date" name="date" className="mt-1 bg-[#001840] block w-full p-2 border-white border shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" />
                </div>
                <div>
                  <label htmlFor="time" className="block text-sm font-medium text-white">
                    Time
                  </label>
                  <select id="time" name="time" className="mt-1 bg-[#001840] block w-full p-2 border-white border shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div className="flex items-center gap-2">
                  <input type="checkbox" id="terms" name="terms" className="p-2 bg-[#001840] border-white border text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" />
