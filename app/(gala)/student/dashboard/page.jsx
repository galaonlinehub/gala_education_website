...
import LeftTiltedBook from "../../../../components/vectors/LeftTiltedBook.jsx";
...
export default function Component() {
  ...
  return (
    <div className="relative flex w-full lg:w-2/3 gap-8 flex-col z-10 lg:flex-row justify-between p-4 lg:p-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            {["Math", "English"].map((subject, index) => (
              <div key={index} className="border-2 border-blue-600 flex flex-wrap items-center justify-between font-bold text-xs rounded-md w-full p-2">
                ...
                <span className="w-1/2 sm:w-1/3 md:w-1/6 text-center py-2">{index === 0 ? "45%" : "05%"}</span>
              </div>
            ))}
          </div>
        </div>
