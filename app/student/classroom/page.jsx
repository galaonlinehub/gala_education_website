        ...
        <div className="flex flex-col w-full lg:justify-between lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-2/3 space-y-6 ">
            {/* <h1 className="text-xl sm:text-2xl font-bold text-gray-900">
              Welcome to your class, Diana Malle
            </h1> */}
              ...
              <div className="p-4 overflow-x-auto">
                <div className="min-w-max">
                  <div className="grid grid-cols-7 gap-2 mb-4">
                    {["Block", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map(
                      (day, index) => (
                        <div
                          key={index}
                          className="h-12 bg-blue-950 text-white rounded-lg flex items-center justify-center text-sm font-medium"
                        >
                          {day}
                        </div>
                      )
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-3">
                    ...
                    {pdfDownloads.map((item, index) => (
                      <div
                        key={index}
                        className="bg-[#0C6667] rounded-lg p-3 flex items-center justify-between group hover:bg-[#0a5758] transition-colors"
                      >
            ...
            >
              ...
              <section className="bg-white rounded-xl shadow-sm p-4">
                ...
                <p className="text-sm text-gray-600 italic">
                  This is where you will find important updates on assignments,
                  subjects, and homework. Stay tuned for new announcements to
                  keep track of any changes or additional tasks!
                </p>
              </section>
              ...
              <section className="bg-blue-950 rounded-xl shadow-sm p-4">
                ...
                <div className="space-y-3">
                  {reminders.map((item, index) => (
                    <div
                      key={index}
                      className="border border-white/20 rounded-lg p-3 flex items-center gap-3 hover:bg-white/5 transition-colors"
                    >
                      <ReminderIcon />
                      <div className="text-white">
                        <p className="text-sm font-medium">{item.name}</p>
