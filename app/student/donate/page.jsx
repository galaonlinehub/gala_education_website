        ...
        >
          <div style={{ marginBottom: "32px", textAlign: "center" }}>
            ...
            <Paragraph style={{ fontSize: "16px", color: "#595959" }}>
              Your donation helps provide educational resources to students in need
            </Paragraph>
          </div>
          ...
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
              ...
              <Row gutter={[24, 24]}>
                  ...
                  <div style={{ marginBottom: "24px" }}>
                    ...
                    <Form.Item label="Amount">
                      <InputNumber
                        min={100}
                        style={{ width: "100%" }}
                        formatter={value => `TZS ${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                ...
                <Col xs={24} lg={12}>
                  ...
                  >
                    <List
                      ...
                      renderItem={item => (
                        <List.Item>
                          <List.Item.Meta
                            avatar={<Avatar style={{ backgroundColor: "#1890ff", verticalAlign: 'middle' }}>{item.icon}</Avatar>}
                            title={`TZS ${item.amount.toLocaleString()}`}
                            description={item.impact}
                          />
                          {selectedAmount >= item.amount && (
                            <Badge status="success" text="Your donation will help!" />
                          )}
                        </List.Item>
                      )}
                    />
                  ...
                  <Card title="Why Donate?">
                    <Paragraph>
                      Many students are unable to afford educational resources, limiting their access to 
                      vital learning materials. Your donation helps us:
                    </Paragraph>
            ...
            {currentStep === 2 && (
              <div style={{ maxWidth: "600px", margin: "0 auto" }}>
                ...
                <Paragraph style={{ fontSize: "12px", color: "#595959" }}>
