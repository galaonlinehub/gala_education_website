  ...
  return (
    <div className="flex flex-col lg:flex-row w-full gap-12 justify-between p-6 bg-orange-100">
            ...
            <div className="flex items-center mt-2">
              ...
              >
                {subjects.map((subject, index) => (
                  <div
                    key={index}
                    className="flex-none flex-col text-xs font-bold rounded-md w-60 h-28 p-5 bg-blue-900 text-white"
                  >
      ...
      <button
        ...
        className="fixed bottom-4 right-4 lg:hidden bg-blue-900 text-white p-2 rounded-full z-10"
      ...
      <div
        className={`fixed inset-y-0 left-0 z-50 bg-blue-900 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="h-full overflow-y-auto flex flex-col items-center justify-center p-6">
          ...
          <hr
            className="bg-white w-5/6 mb-6"
            style={{ height: "0.4px", border: "none" }}
          />
