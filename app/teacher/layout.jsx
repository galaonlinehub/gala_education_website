    ...
    <>
      ...
      {/* <div className="fixed top-16 left-0 bg-white right-0 z-40 border-b">
        <div className="flex flex-col md:flex-row items-center justify-between px-4 py-2 gap-4">
          <input
            className="h-10 px-4 w-full md:w-1/3 rounded-lg border-2 border-blue-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none"
            placeholder="Search..."
          />
