        ...
        <div className="w-full lg:w-2/3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            {mySubjects.map((subject, index) => (
              <div
                key={index}
                className="bg-[#001840] text-white p-4 cursor-pointer"
              >
        ...
        <div className="w-full lg:w-1/3">
          ...
          >
            ...
            <div className="flex text-white text-xs flex-col items-center justify-center">
              <button className="p-1 rounded-3xl font-semibold mt-8 mb-10 border border-white w-20">
                Edit
              </button>
              <span style={{ fontSize: "10px" }} className="italic">
                <b>Note:</b> Organizing topics effectively helps ensure clear
                progression and deeper understanding for students.
              </span>
            </div>
          </div>
        </div>
