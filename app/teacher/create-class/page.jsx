...
export default function CreateClass() {
  ...
  const { data: gradeData, isLoading: isGradesLoading, error: gradesError } = useQuery({
    queryKey: ["grades"],
    queryFn: async () => {
  ...
  const { data: subjectData, isLoading: isSubjectLoading, error: subjectError } = useQuery({
    queryKey: ["subjects"],
    queryFn: async () => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={handleChange}
              onBlur={handleBlur}
              className={`w-full border-2 ${touched.subject && errors.subject ? 'border-red-500' : 'border-blue-700'} p-2`}
              disabled={isLoading || isRedirecting}
            >
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full border-2 ${touched.price && errors.price ? 'border-red-500' : 'border-blue-700'} p-2`}
              disabled={isLoading || isRedirecting}
            />
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              onBlur={handleBlur}
              className={`w-full border-2 ${touched.startDate && errors.startDate ? 'border-red-500' : 'border-blue-700'} p-2`}
              disabled={isLoading || isRedirecting}
            />
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              onBlur={handleBlur}
              className={`w-full border-2 ${touched.endDate && errors.endDate ? 'border-red-500' : 'border-blue-700'} p-2`}
              disabled={isLoading || isRedirecting}
            />
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className={`w-full border-2 ${touched.description && errors.description ? 'border-red-500' : 'border-blue-700'} p-2`}
              disabled={isLoading || isRedirecting}
            />
