  ...
  return (
    <div className="flex flex-col lg:flex-row w-full gap-12 justify-between p-6 ">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex gap-4 items-center">
              <button
                ...
                className="p-1.5 h-5 w-5 flex items-center justify-center rounded-md bg-[#001840] text-white"
              >
                <AiOutlinePlus />
              </button>
              ...
              {isSubtopicLoading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3  gap-2 mb-8">
                  {subtopicData.map((subtopic, index) => (
                    <div
                      key={index}
                      className="bg-[#001840] text-white text-xs font-bold w-48 h-28 p-4 rounded-lg cursor-pointer"
                    >
      ...
      <button
        ...
        className="fixed bottom-4 right-4 lg:hidden bg-[#001840] text-white p-2 rounded-full z-10"
      ...
      <div
        className={`h-screen inset-y-0 left-0  bg-[#001840] transform transition-transform duration-300 ease-in-out z-0 ${
          showSidebar ? "translate-x-0" : "-translate-x-full"
        } lg:relative lg:translate-x-0 lg:w-1/3`}
      >
        <button
        ...
        <div className="h-full overflow-y-auto flex flex-col items-center justify-center p-6">
          <Calendar
            onChange={setDate}
            value={date}
            className=" !bg-[#001F52] text-white !border-none !w-full"
          ...
          <div className="flex justify-between p-4 w-full">
            ...
            <div className="flex gap-2">
              <div className="text-white rounded-md w-16 text-center bg-blue-950 p-1 text-sm">
                8:00
              </div>
              <div className="flex gap-1">
                <span className="p-1 rounded-md w-10 text-center bg-white text-sm">
                  AM
                </span>
                <span className="p-1 rounded-md w-10 text-center bg-blue-950 text-white text-sm">
                  PM
                </span>
              </div>
            </div>
          ...
          <div className="w-full p-4">
            {reminders.map((item, index) => (
              <div
                key={index}
                className="border mb-2 border-white flex justify-start gap-4 items-center rounded-md p-2 h-12"
              >
                {item.icon}
                <div className="flex flex-col">
