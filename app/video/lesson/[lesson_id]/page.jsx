...
export default function Lesson({ params }) {
  ...
  const renderInstructorVideo = useMemo(() => {
    ...
    return (
      ...
      >
        ...
        />
        <Text className="absolute bottom-2 left-2 bg-black/50 text-white px-2 py-1 rounded">
  ...
  return (
    <div className="w-screen  h-screen flex overflow-hidden justify-center relative">
      {!board ? (
