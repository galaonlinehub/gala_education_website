  ...
  return (
    <Layout className="min-h-screen bg-gray-50">
      <Content className={`p-6 ${isMobile ? "px-2" : ""}`}>
        <span className="flex text-xs lg:text-sm justify-center w-full font-extralight mb-5 text-blue-600">
          Your profile will be visible to Student users
        </span>
        ...
        <Card className="mb-6 shadow-md">
          ...
          >
            <div
              className={`flex ${
                isMobile ? "flex-col items-center w-full" : "items-center"
              }`}
            >
              <Avatar
                src={
              ...
              <div className="text-center lg:text-start flex flex-col">
                ...
                <span className="m-0 text-xsn first-letter:capitalize font-extralight lg:text-sm">
                  {user?.role}
                </span>
              </div>
            </div>
                    ...
                    rules={[
                      {
                        ...
                        message: (
                          <span className="text-xs">
                            Select atleast 1 Special group
                          </span>
                        ),
                      },
                    ]}
