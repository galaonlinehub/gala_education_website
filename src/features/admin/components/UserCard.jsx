                ...
                <div className="flex gap-x-4 items-center">
                    ...
                    <div>
                        <div className="flex items-start flex-col gap-y-1">
                            <h1 className="text-ink-heading font-black text-xl">
                                {name}
                            </h1>
                            ...
                            <div className="flex gap-x-2">
                                ...
                                <button
                                  ...
                                  </>):<div className="border-green-800 border-2 items-center gap-x-1 text-green-800 rounded-md p-1 flex">verified <RiVerifiedBadgeFill className="text-blue-700" /> </div>}
                            </div>
                        </div>
                    </div>
                </div>
