        ...
        >
            <div style={{ maxHeight: '60vh', overflowY: 'auto', padding: '0 8px' }}>
                <Typography>
                    ...
                    <Paragraph>
                        GalaAI is an educational artificial intelligence system designed to support academic learning, exam preparation, content creation, and classroom productivity for students and educators. Use of GalaAI is strictly limited to academic and educational purposes.
                    </Paragraph>
                    ...
                    <ul>
                        <li>You are at least 13 years of age, or have obtained verifiable consent from a parent or guardian if under 18.</li>
                        <li>You are competent under Tanzanian law to enter into this legally binding agreement.</li>
                        <li>You are acting on your own behalf or as an authorized representative of an educational institution.</li>
                    </ul>
                    ...
                    <Paragraph>
                        You agree to use GalaAI strictly for lawful, educational, and academic purposes. GalaAI is not intended for commercial exploitation, entertainment unrelated to education, or professional consulting.
                    </Paragraph>
                    ...
                    <ul>
                        ...
                        <li>2.2.5 Using GalaAI to generate, distribute, or promote misinformation, hate speech, or violence.</li>
                    </ul>
                    ...
                    <Paragraph>
                        GalaAI may collect and process data such as:
                    </Paragraph>
                    <ul>
                    ...
                    <Paragraph>
                        All personal data is processed in accordance with the <strong>Tanzania Data Protection Act, 2022</strong>. Gala Education commits to not selling, leasing, or trading any user data to third parties.
                    </Paragraph>
                    ...
                    <Paragraph>
                        Data collected through GalaAI may be anonymized and used to train or improve AI models. Such data shall be stripped of personally identifiable information before being used for research, monitoring, or development purposes.
                    </Paragraph>
                    ...
                    <Paragraph>
                        Gala Education does not access or monitor individual sessions in real time unless required by law, court order, or to investigate suspected abuse or violations of this Agreement.
                    </Paragraph>
                    ...
                    <Paragraph>
                        All underlying technology, algorithms, interfaces, training datasets, branding, and content of GalaAI remain the exclusive property of Gala Education. This includes any improvements or derivatives made during your use of the system.
                    </Paragraph>
                    ...
                    <Paragraph>
                        You are granted a limited, revocable, non-exclusive, and non-transferable license to use GalaAI for academic purposes only. This license does not grant any ownership rights over the AI or its outputs.
                    </Paragraph>
                    ...
                    <Paragraph>
                        You retain ownership of any original material you input into GalaAI. However, you grant Gala Education a royalty-free, worldwide license to use your input and generated outputs for internal improvement, safety, and audit purposes.
                    </Paragraph>
                    ...
                    <Paragraph>
                        To the maximum extent allowed by Tanzanian law, Gala Education shall not be liable for:
                    </Paragraph>
                    <ul>
                        <li>Any indirect, incidental, special, or consequential damages.</li>
                        <li>Academic penalties, expulsion, or disciplinary actions taken due to misuse of AI-generated work.</li>
                    ...
                    <Paragraph>
                        You agree to indemnify and hold harmless Gala Education, its directors, employees, affiliates, and partners against any legal claim or liability resulting from:
                    </Paragraph>
                    <ul>
                        <li>Your misuse of GalaAI;</li>
                        <li>Your breach of this Agreement;</li>
                        <li>Any violation of academic, institutional, or national legal standards due to use of AI outputs.</li>
                    </ul>
                    ...
                    <Paragraph>
                        Gala Education may suspend or permanently restrict your access to GalaAI without prior notice if:
                    </Paragraph>
                    <ul>
                        <li>You breach any part of this Agreement;</li>
                        <li>You use the system in a way that endangers the security or reliability of the platform;</li>
                    ...
                    <Paragraph>
                        This Agreement is governed by the laws of the United Republic of Tanzania, including but not limited to:
                    </Paragraph>
                    <ul>
                    ...
                    <Paragraph>
                        All disputes arising under or related to this Agreement shall be subject to the exclusive jurisdiction of the courts of Tanzania, and you hereby submit to the same.
                    </Paragraph>
                    ...
                    <Paragraph>
                        Gala Education reserves the right to revise this Agreement at any time. Any changes will be effective immediately upon publication on the Gala Education platform or via in-app notifications.
                    </Paragraph>
                    ...
                    <Paragraph>
                        Your continued access or use of GalaAI following any modifications constitutes your binding acceptance of the updated terms.
                    </Paragraph>
                    ...
                    <Paragraph>
                        This Agreement constitutes the entire understanding between you and Gala Education regarding your use of GalaAI. It supersedes all prior oral or written communications.
                    </Paragraph>
                    ...
                    <Paragraph>
                        If any provision in this Agreement is found to be unlawful or unenforceable under Tanzanian law, the remaining provisions shall remain valid and enforceable.
                    </Paragraph>

                    <Title level={4}>11. ACKNOWLEDGMENT AND CONSENT</Title>

                    <Paragraph>
                        By using GalaAI, you acknowledge that:
                    </Paragraph>
                    <ol>
                        <li>You have read, understood, and agreed to be bound by this Agreement;</li>
                        <li>You release Gala Education from any liability associated with your use of the AI;</li>
                        <li>This Agreement remains in force for as long as you use the GalaAI system, regardless of updates or changes.</li>
                    </ol>
                </Typography>
