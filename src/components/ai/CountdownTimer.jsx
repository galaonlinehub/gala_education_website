        ...
        <div className="flex items-center justify-center p-4 mt-8">
            <div className="bg-[#001840]/80 bg-gradient-to-br rounded-3xl p-8 md:p-12 shadow-2xl border border-white/20 max-w-2xl w-full">
                ...
                {!isExpired && (
                    <div className="w-full bg-white/20 rounded-full h-3 mb-6">
                        <div
                            ...
                            style={{
                                width: `${Math.max(0, 100 - ((timeLeft.days * 24 * 60 * 60 + timeLeft.hours * 60 * 60 + timeLeft.minutes * 60 + timeLeft.seconds) / (7 * 24 * 60 * 60) * 100))}%`
                            }}
                        ></div>
                    </div>
                )}
                ...
                <div className="text-center text-white/60 mb-4">
                    <p className="text-sm">
                        {isExpired ? 'Timer completed, should be available any time now!' : 'We are currently making some updates to this section to give you an even more satisfying user experience. Stay tuned!'}
                    </p>
                </div>
            </div>
        </div>
