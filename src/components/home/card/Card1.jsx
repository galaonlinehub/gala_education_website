...
function Card1({ image, title, desc, details }) {
  ...
  return (
    <>
      <div onClick={showModal} className="flex-col cursor-pointer flex md:w-56 lg:min-w-[15rem] md:max-w-[15rem] h-[16rem]  md:h-[12rem] 2xl:w-[400px]  shadow-[0px_2px_2px_rgba(0,0,0,0.3)]">
