...
const ConfirmPlan = () => {
  ...
  return (
    <div className="!py-16 !px-4 flex flex-col lg:flex-row gap-4 lg:gap-12 justify-center items-center">
      {plans.map((plan) => (
        <Card
          key={plan.planId}
          className="
                  !border-[3px] !border-[#030DFE] !rounded-xl 
                  !transition-all !duration-300 hover:!shadow-none
                  !w-full sm:!w-[400px]
                "
        >
          <div className="!flex !flex-col !gap-12 !py-6 !px-6">
            ...
            <Text className="text-center text-gray-700">
              This fee grants you full access to Gala Education&apos;s teaching
              platform, allowing you to connect with students, manage lessons,
              and utilize our advanced tools and resources to deliver
            ...
            <div className="text-center">
              ...
              <Text className="text-gray-600">({plan.billingPeriod})</Text>
            </div>
            ...
            <div className="!mt-auto w-full flex items-center justify-center">
              <Button
                ...
                className="
                        !bg-[#010798] !rounded-lg !h-12 !px-8
                        !font-semibold !text-base !min-w-[160px]
