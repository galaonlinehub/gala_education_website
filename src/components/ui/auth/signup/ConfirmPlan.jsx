...
const ConfirmPlan = () => {
    ...
    return (
        <section className='flex flex-col lg:flex-row justify-center items-center w-full gap-24 my-6'>
            <div
                className="border-[3px] border-[#030DFE] rounded-xl w-[300px] sm:w-[342px] h-[467px] flex flex-col items-center p-8 gap-12 ">
                ...
                <span className={'text-center text-[12px] text-black font-medium'}>
                    This fee grants you full access to Gala Education&#39;s teaching platform, allowing you to connect with students, manage lessons, and utilize our advanced tools and resources to deliver high-quality education.
                </span>
                ...
                <Button className='!rounded-sm !bg-[#010798] !w-[146px] !h-[46.28px]' type="primary">CONTINUE</Button>
            </div>
            <div
                className="border-[3px] border-[#030DFE] w-[300px] sm:w-[342px] h-[467px] rounded-xl flex flex-col items-center p-8 gap-12 ">
                <div className='flex flex-col items-center'>
                    <span className='text-black text-[16px] font-extrabold'>Monthly Bill</span>
                    <span className='text-[10px] text-[#8C8B8D]'>7-day-money-back-guarantee</span>
                </div>
            ...
            <svg className="absolute sm:w-[200px] sm:h-[200px] lg:w-[500px] lg:h-[500px]"  viewBox="0 0 496 360" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
