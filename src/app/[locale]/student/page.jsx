                    ...
                    columns={[
                      ...
                      },
                      {
                        ...
                        render: (_, record) => (
                          <button
                            disabled={true}
                            className={clsx("py-1.5 px-4 text-xs font-semibold text-white rounded-full disabled:pointer-events-none disabled:cursor-not-allowed transition-all duration-200 shadow-sm",
                              {
...
const DashboardHeader = () => {
  ...
  return (
    <Card className="w-full shadow-xl border-0 rounded-xl overflow-hidden bg-gradient-to-br from-white via-blue-50 to-white" style={{
